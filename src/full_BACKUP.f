...
: GPLEV 32 / 4 * GPLEV0 + ;
: PIN_LEVEL DUP GPLEV @ SWAP 32 MOD 1 SWAP LSHIFT AND IF 1 ELSE 0 THEN ;
...
: DHT_PIN_OUT GPIO18_FSEL GPIO18_OUTPUT GPFSEL1 ;

: DHT_OUT DHT_PIN_OUT ENABLE_PIN ;

: DHT_PIN_INP GPIO18_FSEL GPIO18_INPUT GPFSEL1 ;
