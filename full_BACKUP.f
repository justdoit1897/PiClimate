...
\ Embedded Systems A. A. 2022/2023
\ Università degli Studi di Palermo
\ CdL in Ingegneria Informatica LM-32
\ Mario Tortorici,      0737892 
...
\ 24 BILS         CONSTANT GPIO18_OUT
\ 0               CONSTANT GPIO18_INP
...
\ 10# 26 FSEL_MASK    CONSTANT GPIO8_FSEL

: RESET_PIN GPIO8_FSEL GPIO8_INPUT GPIO8_GPFSEL ;

: SET_PULL
    GPPUD !                                                         150 MILLISECONDS DELAY
    GPPUDCLK0 DUP @
    ROT 2DUP
    BIC >R
    OR OVER !                                                       150 MILLISECONDS DELAY
    R> SWAP ! ;
